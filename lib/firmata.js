...
/**
 * Terminate communication (close pc serial port)
 * @param {function} callback A function to be called when serial port is closed
 */
Board.prototype.exit = function(callback) {
