 ...
 *
 */
Board.prototype.pulseIn = function(pin,highOrLow,timeout,callback){
    if(!callback){
        var callback = timeout;
        var timeout = 1000000;
    }
    var timeoutArray = [];
    timeoutArray[0] = ((timeout >> 24) & 0xFF) ;
    timeoutArray[1] = ((timeout >> 16) & 0xFF) ;
    timeoutArray[2] = ((timeout >> 8) & 0XFF);
    timeoutArray[3] = ((timeout & 0xFF));
